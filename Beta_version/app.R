...
server <- function(input, output) {
  ...
  dat <- read.delim("https://raw.githubusercontent.com/yanzhang01/shiny_PgenePapers/master/Beta_version/codingGeneAndpseudoGeneMapping-noRepeatLines_ManuallyCurated_20171106.txt", 
  ...
  ref <- read.delim("https://raw.githubusercontent.com/yanzhang01/shiny_PgenePapers/master/Beta_version/codingGeneAndpseudoGeneMapping_ManuallyCurated_20171106.txt", 
                    header = TRUE, sep = "|", check.names = FALSE, stringsAsFactors = FALSE)
    ...
    fluidPage(
      ...
      fluidRow(
        column(12, align = 'left',
               #simpleNetworkOutput('simple', width = "150%", height = "850px"))
               simpleNetworkOutput('simple', width = "100%", height = "850px"))
      )
    )
  })
